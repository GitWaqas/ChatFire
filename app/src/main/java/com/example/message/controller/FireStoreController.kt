...
object FireStoreController {
    ...
    fun updateCurrentUser(name: String = "", bio: String = "", avatarPath: String? = null) {
        val userFieldMap = mutableMapOf<String, Any>()
        if (name.isNotBlank()) userFieldMap["name"] = name
        if (bio.isNotBlank()) userFieldMap["bio"] = bio
        if (avatarPath != null) userFieldMap["avatarPath"] = avatarPath
    ...
    fun setFCMRegistrationTokens(registrationTokens: MutableList<String>) {
        currentUserRef.update(mapOf("registrationTokens" to registrationTokens))
    }
